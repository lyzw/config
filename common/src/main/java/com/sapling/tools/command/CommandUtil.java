package com.sapling.tools.command;

import com.sapling.common.util.io.StreamUtil;
...
public class CommandUtil {
    ...
    public static CommandExecResult simpleCommand(String command, String charset)
        ...
        result.setResult(new String(StreamUtil.readBytes(stdInputStream), charset));
        result.setError(new String(StreamUtil.readBytes(errInputStream), charset));
        try {
